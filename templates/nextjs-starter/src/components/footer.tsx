export const Footer = () => {
  return (
    <footer className="mx-auto flex h-24 max-w-(--breakpoint-2xl) items-center justify-between px-8 py-16 md:mt-12 md:justify-start md:gap-24 md:px-24 md:pt-0 dark:text-white">
